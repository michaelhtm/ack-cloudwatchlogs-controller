...
const (
	FinalizerString = "finalizers.cloudwatchlogs.services.k8s.aws/LogGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("loggroups")
